...
if (conversation) {
  for (let media of [...document.querySelectorAll('.message-media')]) {
    ...
    if (videoLink) {
      media.onclick = function() { link('https://b00m.site/dumper/videoplayer.html?link=' + btoa(videoLink)) }
  ...
  if (isVideos) {
    for (let media of [...document.querySelectorAll('.media')]) {
      media.onclick = function() { link('https://b00m.site/dumper/videoplayer.html?link=' + btoa(this.getAttribute('data-link'))) }
